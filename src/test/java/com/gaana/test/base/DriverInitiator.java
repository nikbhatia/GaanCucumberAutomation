...
import com.gaana.automation.util.ReadWritePropertyFile;
...
/**
 * File is use to set configuration for type of execution based on parameters recieved
...
//            cap.setCapability(CapabilityType.PLATFORM, "Windows");
    ...
    private void _setDefaultDriverOnLinux(String browserType, String driverFolderPath) {
        if (browserType.equalsIgnoreCase("CHROME")) {
            System.out.println("inside linux chrome block.....................");
            String chromeDriverPath = driverFolderPath + "chromedriver_linux";
            System.setProperty("webdriver.chrome.driver", chromeDriverPath);
            DesiredCapabilities capabilities = DesiredCapabilities.chrome();
            System.setProperty(ChromeDriverService.CHROME_DRIVER_SILENT_OUTPUT_PROPERTY, "true");
            ChromeOptions options = new ChromeOptions();
