...
public class GenericMethod extends BaseAutomation {
	...
	public boolean validateListOfValues(String expectedOptions, By actualLOV) {
		boolean flag = false;
		
		List<WebElement> listOfValues = driver.findElements(actualLOV);
		String[] expectedValues = expectedOptions.split(",");
